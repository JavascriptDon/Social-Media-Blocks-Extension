  ...
  indexHTML: Object.freeze(
    `
      ...
      <fieldset id="settingsDialog">
        ...
        <img class="filter-bg" src="../../assets/images/icon.svg"/>
        <img class="filter-bg" src="../../assets/images/icon-2.svg"/>
        <img class="filter-bg" src="../../assets/images/icon-3.svg"/>
        <img class="filter-bg" src="../../assets/images/icon-4.svg"/>
      </fieldset>
`
  ),
});